...
|24.6| The Micro Price：A High Frequency Estimator of Future Prices | 微观结构 | 将spread和imbalance的离散成不同状态，构建马尔科夫模型来预测midprice的偏差，得到micro price。但由于离散化，似乎不适合做连续的因子，效果不如w_mid，也许可以用来优化那些用到了midprice的因子   | ✅ |
